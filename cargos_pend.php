    ...
    <section class="content-header" >
      <div class="container-fluid">
        <div class="row mb-2" style="margin: 2px">
          <div class="col-sm-9">
            <h5 align="center"><strong><i class="fas fa-list" style="color:green"></i>&nbsp; CARGOS AUTOMATICOS PENDIENTES</strong></h5>
          </div>
          <div class="col-sm-3">
    ...
    <section class="content" style="margin-top: 5px"><!-- Main content -->
      <div class="row">
        <div class="col-12">
            ...
            <div class="card-body"><!--CONTENIDO-->
              ...
              <section class="content">
                <div class="container-fluid"><!--INICIO DE CONTENIDO-->
                  <table id="cargos_pendientes" class="table-hover table-bordered" width="100%" data-order='[[ 0, "desc" ]]'>
         ...
         <input type="hidden" id="name_pag" value="CARGOS AUTOMATICOS">
