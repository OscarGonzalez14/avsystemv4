...
<div class="modal fade bd-example-modal-lg" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" id="nueva_orden_lab_suc" style="border-radius:0px !important;">
  <div class="modal-dialog modal-dialog-scrollable" role="document" id="orden_lab_suc">

  <div class="modal-content">
  <div class="modal-header bg-info" id="head_oid" style="justify-content:space-between">
    <span><i class="far fa-file-alt"></i> ORDEN DE LABORATORIO</span>&nbsp;&nbsp;<span id="correlativo_orden_suc"></span>
  ...
  <div class="form-row align-items-center row" style="margin: 4px"> 
    ...
    <div class="form-group col-sm-5">
      ...
      <div class="input-group">
        <input type="text" class="form-control clear_orden_i" id="paciente_orden_suc" placeholder="Buscar Paciente --> " readonly>
    ...
    <div class="form-group col-sm-3">
      ...
      <select class="form-control clear_orden_i" id="laboratorio_orden_suc" required>
    ...
    <div class="form-group col-sm-4">
      ...
      <select class="form-control clear_orden_i" id="prioridad_orden_suc" required>
  ...
  <div class="form-row align-items-center row" style="margin: 4px">
    ...
    <div class="form-group col-sm-5">
      <div class="input-group">
        ...
        <input type="text" class="form-control clear_orden_i" id="lente_orden_suc" readonly>
      </div>
    </div>
    ...
    <div class="form-group col-sm-7">
      <div class="input-group">
        ...
        <input type="text" class="form-control clear_orden_i" id="tratamiento_orden_suc" readonly>
      </div>
    </div>
  </div>
</div>
...
<div class="eight">
  ...
  <div class="form-row align-items-center row" style="margin: 4px">
    <div class="form-group col-sm-3">
      ...
      <input type="text" class="form-control clear_orden_i" id="modelo_aro_orden_suc" readonly="">
    </div>

    <div class="form-group col-sm-3">
      <label for="">Marca</label>
      <input type="text" class="form-control clear_orden_i" id="marca_aro_orden_suc" readonly="">
    </div>

      <div class="form-group col-sm-3">
      <label for="">Color</label>
      <input type="text" class="form-control clear_orden_i" id="color_aro_orden_suc" readonly="">
    </div>

    <div class="form-group col-sm-3">
      <label for="">Diseño</label>
      <input type="text" class="form-control clear_orden_i" id="diseno_aro_orden_suc" readonly="">
    </div>
  </div>
 ...
 <!--<table style="margin:0px;width:100%">
  ...
  <div class="form-group col-sm-12">
    ...
    <input type="text" class="form-control clear_orden_i" id="observaciones_orden_suc">
  </div>
