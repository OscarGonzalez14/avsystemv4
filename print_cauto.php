...
<?php    
  ...
  <table width="100%" class="table2">
    ...
    <tr>
      <td colspan="100" style="font-size:12px;border: 1px solid black;font-family: Helvetica, Arial, sans-serif;width:100%">&nbsp;&nbsp;<b>EMPRESA:</b>&nbsp;<?php echo $datos_paciente[$j]["empresas"];?></td>
