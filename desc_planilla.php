  ...
  <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2" style="margin: 2px">
          <div class="col-sm-9">
            <h5 align="center"><i class="fas fa-list" style="color:green"></i> <strong>&nbsp;LISTA OIDS PENDIENTES DE APROBACIÓN</strong></h5>
          </div>
          <div class="col-sm-3">
    ...
    <div class="container-fluid">
      <div class="col-md-12">
        ...
        <div class="card" style="margin: 1px">
          ...
          <table id="data_orden_aprob" width="100%" data-order='[[ 0, "desc" ]]' class="table-hover table-bordered">
